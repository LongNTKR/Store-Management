...
from api.routes import products, customers, invoices, import_routes, search, dashboard, ai_config, units, payments, debt_reports
...
app.include_router(debt_reports.router, prefix="/api", tags=["Debt Reports"])
